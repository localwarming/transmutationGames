...
public class CameraMovementv2 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (player.transform.parent != null)
            cameraBase.transform.SetParent(player.transform.parent);
        ...
        cameraBase.transform.position = new Vector3(player.transform.position.x, transform.position.y, player.transform.position.z -15);
    }
